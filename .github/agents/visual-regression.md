...
description: "Screenshot comparison testing -- thresholds, masking, animations, baselines, and CI setup Framework skill ID: visual-regression. Canonical source: .cursor/skills/visual-regression/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: visual-regression
  source_path: .cursor/skills/visual-regression/SKILL.md
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/visual-regression/SKILL.md`. Regenerate: `npm run sync:github-agents`.
