...
description: "Safe refactoring workflow for enum values and static test data -- impact analysis, cascading updates, and verification Framework skill ID: refactor-values. Canonical source: .cursor/skills/refactor-values/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: refactor-values
  source_path: .cursor/skills/refactor-values/SKILL.md
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/refactor-values/SKILL.md`. Regenerate: `npm run sync:github-agents`.
