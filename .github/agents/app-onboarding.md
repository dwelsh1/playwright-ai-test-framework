---
name: app-onboarding
description: "Onboarding a new app into the framework and removing demo apps — directory contract, prompt templates, checklists Framework skill ID: app-onboarding. Canonical source: .cursor/skills/app-onboarding/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: app-onboarding
  source_path: .cursor/skills/app-onboarding/SKILL.md
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/app-onboarding/SKILL.md`. Regenerate: `npm run sync:github-agents`.
