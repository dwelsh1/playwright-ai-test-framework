---
name: clock-mocking
description: "Clock and time mocking -- frozen time, fast-forward, timers, and date-dependent feature testing Framework skill ID: clock-mocking. Canonical source: .cursor/skills/clock-mocking/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: clock-mocking
  source_path: .cursor/skills/clock-mocking/SKILL.md
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/clock-mocking/SKILL.md`. Regenerate: `npm run sync:github-agents`.
