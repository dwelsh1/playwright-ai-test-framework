---
name: forms
description: "Form interaction patterns -- fill vs type, checkboxes, selects, date inputs, file uploads, and multi-step wizards Framework skill ID: forms. Canonical source: .cursor/skills/forms/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: forms
  source_path: .cursor/skills/forms/SKILL.md
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/forms/SKILL.md`. Regenerate: `npm run sync:github-agents`.
