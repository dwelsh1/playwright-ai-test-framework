...
description: "Migration patterns from Cypress and Selenium to Playwright -- command mapping, architecture changes, and common pitfalls Framework skill ID: migration-guides. Canonical source: .cursor/skills/migration-guides/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: migration-guides
  source_path: .cursor/skills/migration-guides/SKILL.md
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/migration-guides/SKILL.md`. Regenerate: `npm run sync:github-agents`.
