---
name: accessibility
description: "Accessibility testing with axe-core -- WCAG compliance, scoped scans, keyboard navigation, and ARIA validation Framework skill ID: accessibility. Canonical source: .cursor/skills/accessibility/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: accessibility
  source_path: .cursor/skills/accessibility/SKILL.md
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/accessibility/SKILL.md`. Regenerate: `npm run sync:github-agents`.
