---
name: selectors
description: "Selector strategy and locator rules for Playwright page objects Framework skill ID: selectors. Canonical source: .cursor/skills/selectors/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: selectors
  source_path: .cursor/skills/selectors/SKILL.md
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/selectors/SKILL.md`. Regenerate: `npm run sync:github-agents`.
