---
name: playwright-cli
description: "Automates browser interactions for page exploration, flow inspection, screenshots, tracing, and action capture. Use when the user needs to navigate websites, inspect web pages, interact with flows, or capture browser actions before writing repo-compliant tests. Framework skill ID: playwright-cli. Canonical source: .cursor/skills/playwright-cli/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: playwright-cli
  source_path: .cursor/skills/playwright-cli/SKILL.md
  allowed_tools_agent_skills: Bash(playwright-cli:*)
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/playwright-cli/SKILL.md`. Regenerate: `npm run sync:github-agents`.
...
>
> This requirement is enforced by the **No Substitute UI Exploration** rule in the orchestrator (`CLAUDE.md` / `.cursor/rules/rules.mdc`).
...
- **Prompt templates and file placement** [.cursor/skills/common-tasks/SKILL.md](../common-tasks/SKILL.md)
- **Test structure, imports, and tags** [.cursor/skills/test-standards/SKILL.md](../test-standards/SKILL.md)
- **Fixture usage and dependency injection** [.cursor/skills/fixtures/SKILL.md](../fixtures/SKILL.md)
- **Selector policy** [.cursor/skills/selectors/SKILL.md](../selectors/SKILL.md)
