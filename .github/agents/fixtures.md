---
name: fixtures
description: "Fixture dependency injection pattern and fixture creation rules Framework skill ID: fixtures. Canonical source: .cursor/skills/fixtures/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: fixtures
  source_path: .cursor/skills/fixtures/SKILL.md
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/fixtures/SKILL.md`. Regenerate: `npm run sync:github-agents`.
