---
name: config
description: "Configuration file conventions and environment variable usage Framework skill ID: config. Canonical source: .cursor/skills/config/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: config
  source_path: .cursor/skills/config/SKILL.md
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/config/SKILL.md`. Regenerate: `npm run sync:github-agents`.
