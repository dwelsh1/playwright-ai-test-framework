---
name: common-tasks
description: "AI prompt templates for common Playwright scaffold development tasks Framework skill ID: common-tasks. Canonical source: .cursor/skills/common-tasks/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: common-tasks
  source_path: .cursor/skills/common-tasks/SKILL.md
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/common-tasks/SKILL.md`. Regenerate: `npm run sync:github-agents`.
