---
name: pw-review
description: "Review Playwright test code, config, fixtures, and framework structure for correctness, resilience, maintainability, and best practices. Use when asked to review Playwright tests, configs, selectors, auth setup, flakiness, or reporting. Framework skill ID: pw-review. Canonical source: .cursor/skills/pw-review/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: pw-review
  source_path: .cursor/skills/pw-review/SKILL.md
  argument-hint: "[paths-or-context]"
  effort: high
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/pw-review/SKILL.md`. Regenerate: `npm run sync:github-agents`.
