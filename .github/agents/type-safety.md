---
name: type-safety
description: "TypeScript type safety and Zod schema rules Framework skill ID: type-safety. Canonical source: .cursor/skills/type-safety/SKILL.md. Regenerate this agent: npm run sync:github-agents"
metadata:
  framework_skill_id: type-safety
  source_path: .cursor/skills/type-safety/SKILL.md
---

> **GitHub Copilot custom agent** — Synced from Agent Skills at `.cursor/skills/type-safety/SKILL.md`. Regenerate: `npm run sync:github-agents`.
